      ...
      <div className="bg-light py-5" style={{ backgroundColor: '#e3f2fd' }}>
        <Row className="justify-content-center">
          <Col md={8} className="text-center">
            <h2 className="mb-4" style={{ fontWeight: '600', color: '#1e88e5' }}>
              Instructions for Uploading Documents
            </h2>
            <div style={{ fontSize: '1.1rem', color: '#555', textAlign: 'center' }}>
        ...
        {documents && documents.length > 0 ? (
          <div className="d-flex flex-column align-items-center">
            {documents.map((doc, index) => (
              <Card className="border-0 shadow-sm mb-3 w-75" key={index}>
